...
def calculate_demographic_data(print_data=True):
    ...
    #len(df.index) --> faster than .count() ???
    ...
    popOver50k = df[df['salary'] == '>50K']['native-country'].value_counts()
    ...
    highest_earning_country = perOver50k[perOver50k.values == perOver50k.max()].index[0]
    highest_earning_country_percentage = round(100 * perOver50k.max(), 1)

    # Identify the most popular occupation for those who earn >50K in India.
    india = df[df['native-country'] == 'India']
    indiaOver50k = india[india['salary'] == '>50K']
    occupation_counts = indiaOver50k['occupation'].value_counts()

    top_IN_occupation = occupation_counts[occupation_counts.values == occupation_counts.max()].index[0]
